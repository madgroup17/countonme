...
/**
 * Created by LinaMaria on 12/05/2017.
 */

public class ImageManagement  implements StreamModelLoader<StorageReference> {

    private static final String TAG = "ImageManagement";
